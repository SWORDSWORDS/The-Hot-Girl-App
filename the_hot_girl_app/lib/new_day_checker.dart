...
class DayChecker {
  ...
  static Future<bool> isNewDay(String lastCheckedDayKey) async {
    final prefs = await SharedPreferences.getInstance();
    final int? lastCheckedDay = prefs.getInt(lastCheckedDayKey);
    ...
    if (lastCheckedDay == null) {
      ...
      await prefs.setInt(lastCheckedDayKey, today);
      return true;
    }
